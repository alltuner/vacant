...
The Python package lives in the [alltuner/vacant](https://github.com/alltuner/vacant) monorepo alongside the Rust engine, so dev commands run from the repo root:
